...
controller.listar = async (req, res) => {
    ...
    try{
        ...
        let dados = await Fornecedor.find()
...
controller.obterUm = async (req, res) => {
    ...
    let obj = await Fornecedor.findById(id)
...
controller.atualizar = async (req, res) => {
    try{
        ...
        // Busca o objeto pelo id e, encontrando-o, subistitui o conteúdo por req.body
        let obj = await Fornecedor.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res)=>{
    try{
        ...
        const id = req.body._id
        let obj = await Fornecedor.findByIdAndDelete(id)
